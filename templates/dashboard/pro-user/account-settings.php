...
<div class="ct-settings-page">
 <button class="ct-settings-page__back-button">
  &rarr; חזרה לבית
 </button>
 ...
 <div class="ct-settings-plan-card">
  <div class="ct-settings-plan-card__header">
   <div class="ct-settings-plan-card__content">
    ...
    <p class="ct-settings-plan-card__description">
     ₪149 לחודש &middot; מתחדש ב-10 בכל חודש
    </p>
   </div>
  ...
  <button class="ct-settings-plan-card__button ct-settings-plan-card__button--secondary">
   <svg aria-hidden="true" class="ct-settings-plan-card__button-icon" fill="none" focusable="false" height="17" stroke="#5E574B" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="17">

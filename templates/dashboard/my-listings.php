...
<a href="https://market.coffeetrail.co.il/" target="_blank">
<picture>
  <source media="(max-width: 600px)" srcset="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/market-mobile.png">
  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/market-desktop.jpeg" alt="Coffeetrail Market" loading="lazy">
</picture>
</a>

...
$ph_caption_1 = c27()->get_setting( 'lightbox_title_caption' );
$ph_caption_2 = c27()->get_setting( 'lightbox_description_caption' );
?>
<input type="hidden" class="photoswipe-config" caption1="<?php echo $ph_caption_1 ?>" caption2=<?php echo $ph_caption_2 ?>>
<?php
